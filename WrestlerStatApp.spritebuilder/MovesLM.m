...
@implementation MovesLM
{
    ...
    -(void)onEnter {
        ...
        totalNS = [defaults objectForKey:@"LM-total"];
        correctNS = [defaults objectForKey:@"LM-correct"];
        percentNS = [defaults objectForKey:@"LM-percent"];
        ...
        totalNS2 = [defaults objectForKey:@"LM-total2"];
        correctNS2 = [defaults objectForKey:@"LM-correct2"];
        percentNS2 = [defaults objectForKey:@"LM-percent2"];
        ...
        totalNS3 = [defaults objectForKey:@"LM-total3"];
        correctNS3 = [defaults objectForKey:@"LM-correct3"];
        percentNS3 = [defaults objectForKey:@"LM-percent3"];
        ...
        totalNS4 = [defaults objectForKey:@"LM-total4"];
        correctNS4 = [defaults objectForKey:@"LM-correct4"];
        percentNS4 = [defaults objectForKey:@"LM-percent4"];
        ...
        totalNS5 = [defaults objectForKey:@"LM-total5"];
        correctNS5 = [defaults objectForKey:@"LM-correct5"];
        percentNS5 = [defaults objectForKey:@"LM-percent5"];
    ...
    -(void) saveValues {
        ...
        [defaults setObject:totalNS forKey:@"LM-total"];
        [defaults setObject:correctNS forKey:@"LM-correct"];
        [defaults setObject:percentNS forKey:@"LM-percent"];
        ...
        [defaults setObject:totalNS2 forKey:@"LM-total2"];
        [defaults setObject:correctNS2 forKey:@"LM-correct2"];
        [defaults setObject:percentNS2 forKey:@"LM-percent2"];
        [defaults synchronize];
        ...
        [defaults setObject:totalNS3 forKey:@"LM-total3"];
        [defaults setObject:correctNS3 forKey:@"LM-correct3"];
        [defaults setObject:percentNS3 forKey:@"LM-percent3"];
        [defaults synchronize];
        ...
        [defaults setObject:totalNS4 forKey:@"LM-total4"];
        [defaults setObject:correctNS4 forKey:@"LM-correct4"];
        [defaults setObject:percentNS4 forKey:@"LM-percent4"];
        [defaults synchronize];
        ...
        [defaults setObject:totalNS5 forKey:@"LM-total5"];
        [defaults setObject:correctNS5 forKey:@"LM-correct5"];
        [defaults setObject:percentNS5 forKey:@"LM-percent5"];
        [defaults synchronize];
    }
