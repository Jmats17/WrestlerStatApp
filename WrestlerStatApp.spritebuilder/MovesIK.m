...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"IK-total"];
    correctNS = [defaults objectForKey:@"IK-correct"];
    percentNS = [defaults objectForKey:@"IK-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"IK-total2"];
    correctNS2 = [defaults objectForKey:@"IK-correct2"];
    percentNS2 = [defaults objectForKey:@"IK-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"IK-total3"];
    correctNS3 = [defaults objectForKey:@"IK-correct3"];
    percentNS3 = [defaults objectForKey:@"IK-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"IK-total4"];
    correctNS4 = [defaults objectForKey:@"IK-correct4"];
    percentNS4 = [defaults objectForKey:@"IK-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"IK-total5"];
    correctNS5 = [defaults objectForKey:@"IK-correct5"];
    percentNS5 = [defaults objectForKey:@"IK-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"IK-total"];
    [defaults setObject:correctNS forKey:@"IK-correct"];
    [defaults setObject:percentNS forKey:@"IK-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"IK-total2"];
    [defaults setObject:correctNS2 forKey:@"IK-correct2"];
    [defaults setObject:percentNS2 forKey:@"IK-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"IK-total3"];
    [defaults setObject:correctNS3 forKey:@"IK-correct3"];
    [defaults setObject:percentNS3 forKey:@"IK-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"IK-total4"];
    [defaults setObject:correctNS4 forKey:@"IK-correct4"];
    [defaults setObject:percentNS4 forKey:@"IK-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"IK-total5"];
    [defaults setObject:correctNS5 forKey:@"IK-correct5"];
    [defaults setObject:percentNS5 forKey:@"IK-percent5"];
    [defaults synchronize];
}
