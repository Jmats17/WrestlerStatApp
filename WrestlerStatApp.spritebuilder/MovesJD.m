...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"JD-total"];
    correctNS = [defaults objectForKey:@"JD-correct"];
    percentNS = [defaults objectForKey:@"JD-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"JD-total2"];
    correctNS2 = [defaults objectForKey:@"JD-correct2"];
    percentNS2 = [defaults objectForKey:@"JD-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"JD-total3"];
    correctNS3 = [defaults objectForKey:@"JD-correct3"];
    percentNS3 = [defaults objectForKey:@"JD-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"JD-total4"];
    correctNS4 = [defaults objectForKey:@"JD-correct4"];
    percentNS4 = [defaults objectForKey:@"JD-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"JD-total5"];
    correctNS5 = [defaults objectForKey:@"JD-correct5"];
    percentNS5 = [defaults objectForKey:@"JD-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"JD-total"];
    [defaults setObject:correctNS forKey:@"JD-correct"];
    [defaults setObject:percentNS forKey:@"JD-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"JD-total2"];
    [defaults setObject:correctNS2 forKey:@"JD-correct2"];
    [defaults setObject:percentNS2 forKey:@"JD-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"JD-total3"];
    [defaults setObject:correctNS3 forKey:@"JD-correct3"];
    [defaults setObject:percentNS3 forKey:@"JD-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"JD-total4"];
    [defaults setObject:correctNS4 forKey:@"JD-correct4"];
    [defaults setObject:percentNS4 forKey:@"JD-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"JD-total5"];
    [defaults setObject:correctNS5 forKey:@"JD-correct5"];
    [defaults setObject:percentNS5 forKey:@"JD-percent5"];
    [defaults synchronize];
}
