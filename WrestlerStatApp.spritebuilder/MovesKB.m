...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"KB-total"];
    correctNS = [defaults objectForKey:@"KB-correct"];
    percentNS = [defaults objectForKey:@"KB-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"KB-total2"];
    correctNS2 = [defaults objectForKey:@"KB-correct2"];
    percentNS2 = [defaults objectForKey:@"KB-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"KB-total3"];
    correctNS3 = [defaults objectForKey:@"KB-correct3"];
    percentNS3 = [defaults objectForKey:@"KB-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"KB-total4"];
    correctNS4 = [defaults objectForKey:@"KB-correct4"];
    percentNS4 = [defaults objectForKey:@"KB-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"KB-total5"];
    correctNS5 = [defaults objectForKey:@"KB-correct5"];
    percentNS5 = [defaults objectForKey:@"KB-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"KB-total"];
    [defaults setObject:correctNS forKey:@"KB-correct"];
    [defaults setObject:percentNS forKey:@"KB-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"KB-total2"];
    [defaults setObject:correctNS2 forKey:@"KB-correct2"];
    [defaults setObject:percentNS2 forKey:@"KB-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"KB-total3"];
    [defaults setObject:correctNS3 forKey:@"KB-correct3"];
    [defaults setObject:percentNS3 forKey:@"KB-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"KB-total4"];
    [defaults setObject:correctNS4 forKey:@"KB-correct4"];
    [defaults setObject:percentNS4 forKey:@"KB-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"KB-total5"];
    [defaults setObject:correctNS5 forKey:@"KB-correct5"];
    [defaults setObject:percentNS5 forKey:@"KB-percent5"];
    [defaults synchronize];
}
