...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"MM-total"];
    correctNS = [defaults objectForKey:@"MM-correct"];
    percentNS = [defaults objectForKey:@"MM-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"MM-total2"];
    correctNS2 = [defaults objectForKey:@"MM-correct2"];
    percentNS2 = [defaults objectForKey:@"MM-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"MM-total3"];
    correctNS3 = [defaults objectForKey:@"MM-correct3"];
    percentNS3 = [defaults objectForKey:@"MM-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"MM-total4"];
    correctNS4 = [defaults objectForKey:@"MM-correct4"];
    percentNS4 = [defaults objectForKey:@"MM-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"MM-total5"];
    correctNS5 = [defaults objectForKey:@"MM-correct5"];
    percentNS5 = [defaults objectForKey:@"MM-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"MM-total"];
    [defaults setObject:correctNS forKey:@"MM-correct"];
    [defaults setObject:percentNS forKey:@"MM-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"MM-total2"];
    [defaults setObject:correctNS2 forKey:@"MM-correct2"];
    [defaults setObject:percentNS2 forKey:@"MM-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"MM-total3"];
    [defaults setObject:correctNS3 forKey:@"MM-correct3"];
    [defaults setObject:percentNS3 forKey:@"MM-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"MM-total4"];
    [defaults setObject:correctNS4 forKey:@"MM-correct4"];
    [defaults setObject:percentNS4 forKey:@"MM-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"MM-total5"];
    [defaults setObject:correctNS5 forKey:@"MM-correct5"];
    [defaults setObject:percentNS5 forKey:@"MM-percent5"];
    [defaults synchronize];
}
