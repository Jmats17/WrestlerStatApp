...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"CP-total"];
    correctNS = [defaults objectForKey:@"CP-correct"];
    percentNS = [defaults objectForKey:@"CP-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"CP-total2"];
    correctNS2 = [defaults objectForKey:@"CP-correct2"];
    percentNS2 = [defaults objectForKey:@"CP-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"CP-total3"];
    correctNS3 = [defaults objectForKey:@"CP-correct3"];
    percentNS3 = [defaults objectForKey:@"CP-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"CP-total4"];
    correctNS4 = [defaults objectForKey:@"CP-correct4"];
    percentNS4 = [defaults objectForKey:@"CP-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"CP-total5"];
    correctNS5 = [defaults objectForKey:@"CP-correct5"];
    percentNS5 = [defaults objectForKey:@"CP-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"CP-total"];
    [defaults setObject:correctNS forKey:@"CP-correct"];
    [defaults setObject:percentNS forKey:@"CP-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"CP-total2"];
    [defaults setObject:correctNS2 forKey:@"CP-correct2"];
    [defaults setObject:percentNS2 forKey:@"CP-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"CP-total3"];
    [defaults setObject:correctNS3 forKey:@"CP-correct3"];
    [defaults setObject:percentNS3 forKey:@"CP-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"CP-total4"];
    [defaults setObject:correctNS4 forKey:@"CP-correct4"];
    [defaults setObject:percentNS4 forKey:@"CP-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"CP-total5"];
    [defaults setObject:correctNS5 forKey:@"CP-correct5"];
    [defaults setObject:percentNS5 forKey:@"CP-percent5"];
    [defaults synchronize];
}
