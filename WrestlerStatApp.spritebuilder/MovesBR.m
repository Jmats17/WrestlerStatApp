...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"BR-total"];
    correctNS = [defaults objectForKey:@"BR-correct"];
    percentNS = [defaults objectForKey:@"BR-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"BR-total2"];
    correctNS2 = [defaults objectForKey:@"BR-correct2"];
    percentNS2 = [defaults objectForKey:@"BR-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"BR-total3"];
    correctNS3 = [defaults objectForKey:@"BR-correct3"];
    percentNS3 = [defaults objectForKey:@"BR-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"BR-total4"];
    correctNS4 = [defaults objectForKey:@"BR-correct4"];
    percentNS4 = [defaults objectForKey:@"BR-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"BR-total5"];
    correctNS5 = [defaults objectForKey:@"BR-correct5"];
    percentNS5 = [defaults objectForKey:@"BR-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"BR-total"];
    [defaults setObject:correctNS forKey:@"BR-correct"];
    [defaults setObject:percentNS forKey:@"BR-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"BR-total2"];
    [defaults setObject:correctNS2 forKey:@"BR-correct2"];
    [defaults setObject:percentNS2 forKey:@"BR-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"BR-total3"];
    [defaults setObject:correctNS3 forKey:@"BR-correct3"];
    [defaults setObject:percentNS3 forKey:@"BR-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"BR-total4"];
    [defaults setObject:correctNS4 forKey:@"BR-correct4"];
    [defaults setObject:percentNS4 forKey:@"BR-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"BR-total5"];
    [defaults setObject:correctNS5 forKey:@"BR-correct5"];
    [defaults setObject:percentNS5 forKey:@"BR-percent5"];
    [defaults synchronize];
}
