...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"SF-total"];
    correctNS = [defaults objectForKey:@"SF-correct"];
    percentNS = [defaults objectForKey:@"SF-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"SF-total2"];
    correctNS2 = [defaults objectForKey:@"SF-correct2"];
    percentNS2 = [defaults objectForKey:@"SF-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"SF-total3"];
    correctNS3 = [defaults objectForKey:@"SF-correct3"];
    percentNS3 = [defaults objectForKey:@"SF-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"SF-total4"];
    correctNS4 = [defaults objectForKey:@"SF-correct4"];
    percentNS4 = [defaults objectForKey:@"SF-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"SF-total5"];
    correctNS5 = [defaults objectForKey:@"SF-correct5"];
    percentNS5 = [defaults objectForKey:@"SF-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"SF-total"];
    [defaults setObject:correctNS forKey:@"SF-correct"];
    [defaults setObject:percentNS forKey:@"SF-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"SF-total2"];
    [defaults setObject:correctNS2 forKey:@"SF-correct2"];
    [defaults setObject:percentNS2 forKey:@"SF-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"SF-total3"];
    [defaults setObject:correctNS3 forKey:@"SF-correct3"];
    [defaults setObject:percentNS3 forKey:@"SF-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"SF-total4"];
    [defaults setObject:correctNS4 forKey:@"SF-correct4"];
    [defaults setObject:percentNS4 forKey:@"SF-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"SF-total5"];
    [defaults setObject:correctNS5 forKey:@"SF-correct5"];
    [defaults setObject:percentNS5 forKey:@"SF-percent5"];
    [defaults synchronize];
}
