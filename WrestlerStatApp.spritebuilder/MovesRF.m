...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"RF-total"];
    correctNS = [defaults objectForKey:@"RF-correct"];
    percentNS = [defaults objectForKey:@"RF-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"RF-total2"];
    correctNS2 = [defaults objectForKey:@"RF-correct2"];
    percentNS2 = [defaults objectForKey:@"RF-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"RF-total3"];
    correctNS3 = [defaults objectForKey:@"RF-correct3"];
    percentNS3 = [defaults objectForKey:@"RF-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"RF-total4"];
    correctNS4 = [defaults objectForKey:@"RF-correct4"];
    percentNS4 = [defaults objectForKey:@"RF-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"RF-total5"];
    correctNS5 = [defaults objectForKey:@"RF-correct5"];
    percentNS5 = [defaults objectForKey:@"RF-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"RF-total"];
    [defaults setObject:correctNS forKey:@"RF-correct"];
    [defaults setObject:percentNS forKey:@"RF-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"RF-total2"];
    [defaults setObject:correctNS2 forKey:@"RF-correct2"];
    [defaults setObject:percentNS2 forKey:@"RF-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"RF-total3"];
    [defaults setObject:correctNS3 forKey:@"RF-correct3"];
    [defaults setObject:percentNS3 forKey:@"RF-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"RF-total4"];
    [defaults setObject:correctNS4 forKey:@"RF-correct4"];
    [defaults setObject:percentNS4 forKey:@"RF-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"RF-total5"];
    [defaults setObject:correctNS5 forKey:@"RF-correct5"];
    [defaults setObject:percentNS5 forKey:@"RF-percent5"];
    [defaults synchronize];
}
