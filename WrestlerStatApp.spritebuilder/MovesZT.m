...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"ZT-total"];
    correctNS = [defaults objectForKey:@"ZT-correct"];
    percentNS = [defaults objectForKey:@"ZT-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"ZT-total2"];
    correctNS2 = [defaults objectForKey:@"ZT-correct2"];
    percentNS2 = [defaults objectForKey:@"ZT-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"ZT-total3"];
    correctNS3 = [defaults objectForKey:@"ZT-correct3"];
    percentNS3 = [defaults objectForKey:@"ZT-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"ZT-total4"];
    correctNS4 = [defaults objectForKey:@"ZT-correct4"];
    percentNS4 = [defaults objectForKey:@"ZT-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"ZT-total5"];
    correctNS5 = [defaults objectForKey:@"ZT-correct5"];
    percentNS5 = [defaults objectForKey:@"ZT-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"ZT-total"];
    [defaults setObject:correctNS forKey:@"ZT-correct"];
    [defaults setObject:percentNS forKey:@"ZT-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"ZT-total2"];
    [defaults setObject:correctNS2 forKey:@"ZT-correct2"];
    [defaults setObject:percentNS2 forKey:@"ZT-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"ZT-total3"];
    [defaults setObject:correctNS3 forKey:@"ZT-correct3"];
    [defaults setObject:percentNS3 forKey:@"ZT-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"ZT-total4"];
    [defaults setObject:correctNS4 forKey:@"ZT-correct4"];
    [defaults setObject:percentNS4 forKey:@"ZT-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"ZT-total5"];
    [defaults setObject:correctNS5 forKey:@"ZT-correct5"];
    [defaults setObject:percentNS5 forKey:@"ZT-percent5"];
    [defaults synchronize];
}
