...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"JL-total"];
    correctNS = [defaults objectForKey:@"JL-correct"];
    percentNS = [defaults objectForKey:@"JL-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"JL-total2"];
    correctNS2 = [defaults objectForKey:@"JL-correct2"];
    percentNS2 = [defaults objectForKey:@"JL-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"JL-total3"];
    correctNS3 = [defaults objectForKey:@"JL-correct3"];
    percentNS3 = [defaults objectForKey:@"JL-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"JL-total4"];
    correctNS4 = [defaults objectForKey:@"JL-correct4"];
    percentNS4 = [defaults objectForKey:@"JL-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"JL-total5"];
    correctNS5 = [defaults objectForKey:@"JL-correct5"];
    percentNS5 = [defaults objectForKey:@"JL-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"JL-total"];
    [defaults setObject:correctNS forKey:@"JL-correct"];
    [defaults setObject:percentNS forKey:@"JL-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"JL-total2"];
    [defaults setObject:correctNS2 forKey:@"JL-correct2"];
    [defaults setObject:percentNS2 forKey:@"JL-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"JL-total3"];
    [defaults setObject:correctNS3 forKey:@"JL-correct3"];
    [defaults setObject:percentNS3 forKey:@"JL-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"JL-total4"];
    [defaults setObject:correctNS4 forKey:@"JL-correct4"];
    [defaults setObject:percentNS4 forKey:@"JL-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"JL-total5"];
    [defaults setObject:correctNS5 forKey:@"JL-correct5"];
    [defaults setObject:percentNS5 forKey:@"JL-percent5"];
    [defaults synchronize];
}
