...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"RP-total"];
    correctNS = [defaults objectForKey:@"RP-correct"];
    percentNS = [defaults objectForKey:@"RP-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"RP-total2"];
    correctNS2 = [defaults objectForKey:@"RP-correct2"];
    percentNS2 = [defaults objectForKey:@"RP-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"RP-total3"];
    correctNS3 = [defaults objectForKey:@"RP-correct3"];
    percentNS3 = [defaults objectForKey:@"RP-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"RP-total4"];
    correctNS4 = [defaults objectForKey:@"RP-correct4"];
    percentNS4 = [defaults objectForKey:@"RP-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"RP-total5"];
    correctNS5 = [defaults objectForKey:@"RP-correct5"];
    percentNS5 = [defaults objectForKey:@"RP-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"RP-total"];
    [defaults setObject:correctNS forKey:@"RP-correct"];
    [defaults setObject:percentNS forKey:@"RP-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"RP-total2"];
    [defaults setObject:correctNS2 forKey:@"RP-correct2"];
    [defaults setObject:percentNS2 forKey:@"RP-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"RP-total3"];
    [defaults setObject:correctNS3 forKey:@"RP-correct3"];
    [defaults setObject:percentNS3 forKey:@"RP-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"RP-total4"];
    [defaults setObject:correctNS4 forKey:@"RP-correct4"];
    [defaults setObject:percentNS4 forKey:@"RP-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"RP-total5"];
    [defaults setObject:correctNS5 forKey:@"RP-correct5"];
    [defaults setObject:percentNS5 forKey:@"RP-percent5"];
    [defaults synchronize];
}
