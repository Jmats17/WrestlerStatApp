...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"SM-total"];
    correctNS = [defaults objectForKey:@"SM-correct"];
    percentNS = [defaults objectForKey:@"SM-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"SM-total2"];
    correctNS2 = [defaults objectForKey:@"SM-correct2"];
    percentNS2 = [defaults objectForKey:@"SM-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"SM-total3"];
    correctNS3 = [defaults objectForKey:@"SM-correct3"];
    percentNS3 = [defaults objectForKey:@"SM-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"SM-total4"];
    correctNS4 = [defaults objectForKey:@"SM-correct4"];
    percentNS4 = [defaults objectForKey:@"SM-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"SM-total5"];
    correctNS5 = [defaults objectForKey:@"SM-correct5"];
    percentNS5 = [defaults objectForKey:@"SM-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"SM-total"];
    [defaults setObject:correctNS forKey:@"SM-correct"];
    [defaults setObject:percentNS forKey:@"SM-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"SM-total2"];
    [defaults setObject:correctNS2 forKey:@"SM-correct2"];
    [defaults setObject:percentNS2 forKey:@"SM-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"SM-total3"];
    [defaults setObject:correctNS3 forKey:@"SM-correct3"];
    [defaults setObject:percentNS3 forKey:@"SM-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"SM-total4"];
    [defaults setObject:correctNS4 forKey:@"SM-correct4"];
    [defaults setObject:percentNS4 forKey:@"SM-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"SM-total5"];
    [defaults setObject:correctNS5 forKey:@"SM-correct5"];
    [defaults setObject:percentNS5 forKey:@"SM-percent5"];
    [defaults synchronize];
}
