...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"JB-total"];
    correctNS = [defaults objectForKey:@"JB-correct"];
    percentNS = [defaults objectForKey:@"JB-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"JB-total2"];
    correctNS2 = [defaults objectForKey:@"JB-correct2"];
    percentNS2 = [defaults objectForKey:@"JB-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"JB-total3"];
    correctNS3 = [defaults objectForKey:@"JB-correct3"];
    percentNS3 = [defaults objectForKey:@"JB-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"JB-total4"];
    correctNS4 = [defaults objectForKey:@"JB-correct4"];
    percentNS4 = [defaults objectForKey:@"JB-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"JB-total5"];
    correctNS5 = [defaults objectForKey:@"JB-correct5"];
    percentNS5 = [defaults objectForKey:@"JB-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"JB-total"];
    [defaults setObject:correctNS forKey:@"JB-correct"];
    [defaults setObject:percentNS forKey:@"JB-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"JB-total2"];
    [defaults setObject:correctNS2 forKey:@"JB-correct2"];
    [defaults setObject:percentNS2 forKey:@"JB-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"JB-total3"];
    [defaults setObject:correctNS3 forKey:@"JB-correct3"];
    [defaults setObject:percentNS3 forKey:@"JB-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"JB-total4"];
    [defaults setObject:correctNS4 forKey:@"JB-correct4"];
    [defaults setObject:percentNS4 forKey:@"JB-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"JB-total5"];
    [defaults setObject:correctNS5 forKey:@"JB-correct5"];
    [defaults setObject:percentNS5 forKey:@"JB-percent5"];
    [defaults synchronize];
}
