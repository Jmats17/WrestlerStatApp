...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"DS-total"];
    correctNS = [defaults objectForKey:@"DS-correct"];
    percentNS = [defaults objectForKey:@"DS-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"DS-total2"];
    correctNS2 = [defaults objectForKey:@"DS-correct2"];
    percentNS2 = [defaults objectForKey:@"DS-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"DS-total3"];
    correctNS3 = [defaults objectForKey:@"DS-correct3"];
    percentNS3 = [defaults objectForKey:@"DS-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"DS-total4"];
    correctNS4 = [defaults objectForKey:@"DS-correct4"];
    percentNS4 = [defaults objectForKey:@"DS-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"DS-total5"];
    correctNS5 = [defaults objectForKey:@"DS-correct5"];
    percentNS5 = [defaults objectForKey:@"DS-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"DS-total"];
    [defaults setObject:correctNS forKey:@"DS-correct"];
    [defaults setObject:percentNS forKey:@"DS-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"DS-total2"];
    [defaults setObject:correctNS2 forKey:@"DS-correct2"];
    [defaults setObject:percentNS2 forKey:@"DS-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"DS-total3"];
    [defaults setObject:correctNS3 forKey:@"DS-correct3"];
    [defaults setObject:percentNS3 forKey:@"DS-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"DS-total4"];
    [defaults setObject:correctNS4 forKey:@"DS-correct4"];
    [defaults setObject:percentNS4 forKey:@"DS-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"DS-total5"];
    [defaults setObject:correctNS5 forKey:@"DS-correct5"];
    [defaults setObject:percentNS5 forKey:@"DS-percent5"];
    [defaults synchronize];
}
