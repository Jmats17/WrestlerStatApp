...
-(void)onEnter {
    ...
    totalNS = [defaults objectForKey:@"TrN-total"];
    correctNS = [defaults objectForKey:@"TrN-correct"];
    percentNS = [defaults objectForKey:@"TrN-percent"];
    ...
    totalNS2 = [defaults objectForKey:@"TrN-total2"];
    correctNS2 = [defaults objectForKey:@"TrN-correct2"];
    percentNS2 = [defaults objectForKey:@"TrN-percent2"];
    ...
    totalNS3 = [defaults objectForKey:@"TrN-total3"];
    correctNS3 = [defaults objectForKey:@"TrN-correct3"];
    percentNS3 = [defaults objectForKey:@"TrN-percent3"];
    ...
    totalNS4 = [defaults objectForKey:@"TrN-total4"];
    correctNS4 = [defaults objectForKey:@"TrN-correct4"];
    percentNS4 = [defaults objectForKey:@"TrN-percent4"];
    ...
    totalNS5 = [defaults objectForKey:@"TrN-total5"];
    correctNS5 = [defaults objectForKey:@"TrN-correct5"];
    percentNS5 = [defaults objectForKey:@"TrN-percent5"];
...
-(void) saveValues {
    ...
    [defaults setObject:totalNS forKey:@"TrN-total"];
    [defaults setObject:correctNS forKey:@"TrN-correct"];
    [defaults setObject:percentNS forKey:@"TrN-percent"];
    ...
    [defaults setObject:totalNS2 forKey:@"TrN-total2"];
    [defaults setObject:correctNS2 forKey:@"TrN-correct2"];
    [defaults setObject:percentNS2 forKey:@"TrN-percent2"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS3 forKey:@"TrN-total3"];
    [defaults setObject:correctNS3 forKey:@"TrN-correct3"];
    [defaults setObject:percentNS3 forKey:@"TrN-percent3"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS4 forKey:@"TrN-total4"];
    [defaults setObject:correctNS4 forKey:@"TrN-correct4"];
    [defaults setObject:percentNS4 forKey:@"TrN-percent4"];
    [defaults synchronize];
    ...
    [defaults setObject:totalNS5 forKey:@"TrN-total5"];
    [defaults setObject:correctNS5 forKey:@"TrN-correct5"];
    [defaults setObject:percentNS5 forKey:@"TrN-percent5"];
    [defaults synchronize];
}
